...
typedef int(*tosInitializationInterrupt)(uint8_t,uint16_t,void *); //typedef for tos function InitializationInterrupt(uint8_t b , uint16_t c , void * d) 
...
class Ns3ToTosProxy {
    public:
		...
		int InitializationInterrupt(uint8_t b , uint16_t c , void * d);
