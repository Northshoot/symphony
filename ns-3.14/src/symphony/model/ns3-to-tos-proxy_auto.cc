...
int
Ns3ToTosProxy::InitializationInterrupt(uint8_t b , uint16_t c , void * d)
{
 	return ((tosInitializationInterrupt)m_tos_functions["InitializationInterrupt"])(b , c , d);
}
void
