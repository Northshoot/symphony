...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2ae2ca8696b0, const void *arg_0x2ae2ca869988);
#line 776
__extension__ 
#line 793
__extension__ 
...
# 80 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2ae2cac8ec70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = Ns3ActiveMessageC$AMSend$send(arg_0x2ae2cac8ec70, addr, msg, len);
#line 80
...
# 100 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2ae2cac8f990, message_t * msg, error_t error){
#line 100
  switch (arg_0x2ae2cac8f990) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2ae2cac8f990, msg, error);
#line 100
      break;
#line 100
    }
...
#line 42
{
  ...
  if (err == SUCCESS) {
      if (TOS_NODE_ID != 0) {
          RadioTestC$MilliTimer$startOneShot(10 * TOS_NODE_ID);
        }
    }
  else {
...
# 110 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void Ns3ActiveMessageC$AMSend$sendDone(am_id_t arg_0x2ae2cace4c60, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2ae2cace4c60, msg, error);
#line 110
}
#line 110
...
# 78 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * Ns3ActiveMessageC$Snoop$receive(am_id_t arg_0x2ae2cace29c0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = Ns3ActiveMessageC$Snoop$default$receive(arg_0x2ae2cace29c0, msg, payload, len);
#line 78
...
# 78 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * Ns3ActiveMessageC$Receive$receive(am_id_t arg_0x2ae2cace3da0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2ae2cace3da0) {
#line 78
    case 12:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = Ns3ActiveMessageC$Receive$default$receive(arg_0x2ae2cace3da0, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 75 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
inline static void SchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2ae2cab18960){
#line 75
  switch (arg_0x2ae2cab18960) {
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP$TaskBasic$default$runTask(arg_0x2ae2cab18960);
#line 75
      break;
#line 75
    }
...
# 83 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2ae2cadc6de0){
#line 83
  switch (arg_0x2ae2cadc6de0) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2ae2cadc6de0);
#line 83
      break;
#line 83
    }
...
# 59 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/SendNotifier.nc"
inline static void Ns3ActiveMessageC$SendNotifier$aboutToSend(am_id_t arg_0x2ae2cace0630, am_addr_t dest, message_t * msg){
#line 59
    Ns3ActiveMessageC$SendNotifier$default$aboutToSend(arg_0x2ae2cace0630, dest, msg);
#line 59
}
#line 59
