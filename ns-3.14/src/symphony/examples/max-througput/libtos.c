...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2ab49bb806b0, const void *arg_0x2ab49bb80988);
#line 776
__extension__ 
#line 793
__extension__ 
...
typedef TMilli ThroughputC$MilliTimer$precision_tag;
...
static void ThroughputC$AMControl$startDone(error_t error);
# 60 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/Boot.nc"
static void ThroughputC$Boot$booted(void );
# 110 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void ThroughputC$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
static void ThroughputC$send$runTask(void );
...
static void ThroughputC$MilliTimer$fired(void );
# 80 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t /*ThroughputApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*ThroughputApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 104 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static error_t ThroughputC$AMControl$start(void );
# 80 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t ThroughputC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 67 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
static error_t ThroughputC$send$postTask(void );
# 15 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/platforms/ns3/timers/RealTimeClock.nc"
static uint64_t ThroughputC$RTC$getTime(PRECISION prec);
# 136 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static uint32_t ThroughputC$MilliTimer$getNow(void );
# 29 "ThroughputC.nc"
enum ThroughputC$__nesc_unnamed4287 {
#line 29
  ThroughputC$send = 0U
};
#line 29
typedef int ThroughputC$__nesc_sillytask_send[ThroughputC$send];

uint32_t ThroughputC$time_exec = 0;
uint64_t ThroughputC$time_rt = 0;


message_t ThroughputC$packet;
uint8_t ThroughputC$dest = 1;
bool ThroughputC$locked;
uint16_t ThroughputC$counter = 0;

static inline void ThroughputC$Boot$booted(void );




static inline void ThroughputC$AMControl$startDone(error_t err);
#line 57
static inline void ThroughputC$send$runTask(void );
#line 88
static void ThroughputC$AMSend$sendDone(message_t *bufPtr, error_t error);
#line 101
static inline void ThroughputC$MilliTimer$fired(void );





static inline message_t *ThroughputC$Receive$receive(message_t *bufPtr, 
void *payload, uint8_t len);
# 110 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void /*ThroughputApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/Send.nc"
static error_t /*ThroughputApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*ThroughputApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*ThroughputApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*ThroughputApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*ThroughputApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/AMSend.nc"
...
# 15 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/platforms/ns3/timers/RealTimeClock.nc"
inline static uint64_t ThroughputC$RTC$getTime(PRECISION prec){
#line 15
...
# 136 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static uint32_t ThroughputC$MilliTimer$getNow(void ){
#line 136
  unsigned int __nesc_result;
#line 136
...
# 80 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2ab49bfb3c70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = Ns3ActiveMessageC$AMSend$send(arg_0x2ab49bfb3c70, addr, msg, len);
#line 80
...
# 75 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static error_t /*ThroughputApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*ThroughputApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*ThroughputApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*ThroughputApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*ThroughputApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 12);
  return /*ThroughputApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t ThroughputC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*ThroughputApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/Packet.nc"
inline static void * ThroughputC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 57
{
  ...
  ThroughputC$counter++;
  if (ThroughputC$locked) {
      printf("LOCKED\n");
      return;
    }
  else {
      radio_count_msg_t *rcm = (radio_count_msg_t *)ThroughputC$Packet$getPayload(&ThroughputC$packet, sizeof(radio_count_msg_t ));
...
#line 67
      ...
      __nesc_hton_uint16(rcm->counter.nxdata, ThroughputC$counter);
      ...
      sendErr = ThroughputC$AMSend$send(ThroughputC$dest, &ThroughputC$packet, sizeof(radio_count_msg_t ));
      if (sendErr == SUCCESS) {
          ThroughputC$locked = true;
          ThroughputC$time_exec = ThroughputC$MilliTimer$getNow();
          ThroughputC$time_rt = ThroughputC$RTC$getTime(MILLISECOND);
          printf("task send():: \t\tlocal %lu - sim %lu\n", ThroughputC$time_exec, ThroughputC$time_rt);
        }
      else 
#line 82
        {
...
# 110 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*ThroughputApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  ThroughputC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*ThroughputApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2ab49bfb4990, message_t * msg, error_t error){
#line 100
  switch (arg_0x2ab49bfb4990) {
#line 100
    case 0U:
#line 100
      /*ThroughputApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2ab49bfb4990, msg, error);
#line 100
      break;
#line 100
    }
...
# 104 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
inline static error_t ThroughputC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
# 67 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
inline static error_t ThroughputC$send$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SchedulerBasicP$TaskBasic$postTask(ThroughputC$send);
#line 67
...
#line 45
{
  ...
  if (err == SUCCESS) {
      if (TOS_NODE_ID == 0) {
        ThroughputC$send$postTask();
        }
    }
  else {
      ThroughputC$AMControl$start();
    }
}
...
#line 113
  ThroughputC$AMControl$startDone(error);
#line 113
}
#line 113
# 54 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/platforms/ns3/Ns3ActiveMessageC.nc"
...
# 110 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void Ns3ActiveMessageC$AMSend$sendDone(am_id_t arg_0x2ab49c005a88, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2ab49c005a88, msg, error);
#line 110
}
#line 110
...
# 78 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * Ns3ActiveMessageC$Snoop$receive(am_id_t arg_0x2ab49c0027c0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = Ns3ActiveMessageC$Snoop$default$receive(arg_0x2ab49c0027c0, msg, payload, len);
#line 78
...
# 78 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * Ns3ActiveMessageC$Receive$receive(am_id_t arg_0x2ab49c003c18, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2ab49c003c18) {
#line 78
    case 12:
#line 78
      __nesc_result = ThroughputC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = Ns3ActiveMessageC$Receive$default$receive(arg_0x2ab49c003c18, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 75 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
inline static void SchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2ab49be2d960){
#line 75
  switch (arg_0x2ab49be2d960) {
#line 75
    case ThroughputC$send:
#line 75
      ThroughputC$send$runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP$TaskBasic$default$runTask(arg_0x2ab49be2d960);
#line 75
      break;
#line 75
    }
...
# 83 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2ab49c0ff160){
#line 83
  switch (arg_0x2ab49c0ff160) {
#line 83
    case 0U:
#line 83
      ThroughputC$MilliTimer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2ab49c0ff160);
#line 83
      break;
#line 83
    }
...
# 59 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/SendNotifier.nc"
inline static void Ns3ActiveMessageC$SendNotifier$aboutToSend(am_id_t arg_0x2ab49c0012f0, am_addr_t dest, message_t * msg){
#line 59
    Ns3ActiveMessageC$SendNotifier$default$aboutToSend(arg_0x2ab49c0012f0, dest, msg);
#line 59
}
#line 59
...
#line 88
{
  if (&ThroughputC$packet == bufPtr) {
      ThroughputC$locked = false;
      ThroughputC$time_exec = ThroughputC$MilliTimer$getNow();
      ThroughputC$time_rt = ThroughputC$RTC$getTime(MILLISECOND);
