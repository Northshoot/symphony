...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2b4536cfa6b0, const void *arg_0x2b4536cfa988);
#line 776
__extension__ 
#line 793
__extension__ 
...
# 75 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
inline static void SchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2b4536fa9960){
#line 75
  switch (arg_0x2b4536fa9960) {
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP$TaskBasic$default$runTask(arg_0x2b4536fa9960);
#line 75
      break;
#line 75
    }
...
#line 28
{
  unsigned int now = RadioTestC$MilliTimer$getNow();
  unsigned int diff = now - RadioTestC$next;

#line 31
  if (diff > 0) {
      printf("(%d)-Time expected: %d now: %d diff: %d\n", TOS_NODE_ID, RadioTestC$next, now, now - RadioTestC$next);
    }
  RadioTestC$next = RadioTestC$MilliTimer$getNow() + 100;
}
...
# 83 "/home/lauril/dev/symphony/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2b453709a160){
#line 83
  switch (arg_0x2b453709a160) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2b453709a160);
#line 83
      break;
#line 83
    }
...
#line 19
{
  ...
  printf("Boot.booted %d at %d\n", TOS_NODE_ID, RadioTestC$MilliTimer$getNow());
  RadioTestC$next = RadioTestC$MilliTimer$getNow();
  RadioTestC$MilliTimer$startPeriodic(100);
  RadioTestC$next = RadioTestC$MilliTimer$getNow() + 100;
}
