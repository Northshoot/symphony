...
namespace ns3 {
    static struct NS_OBJECT_ENSURE_REGISTERED(TosNode)
    {
    } ;
    TypeId TosNode::GetTypeId(void)
    {
        static TypeId tid = TypeId("ns3::TosNode").SetParent<Object>().AddConstructor<TosNode>();
        return tid;
    }
