...
WsnWifiMacHelper::WsnWifiMacHelper ()
{
}
...
WsnWifiMacHelper
WsnWifiMacHelper::Default (void)
{
  WsnWifiMacHelper helper;
  ...
  // attributes.
  helper.SetType ("ns3::WsnWifiMac",
                  "QosSupported", BooleanValue (false));
  return helper;
}

void
WsnWifiMacHelper::SetType (std::string type,
...
Ptr<WsnWifiMac>
WsnWifiMacHelper::Create (void) const
{
  Ptr<WsnWifiMac> mac = m_mac.Create<WsnWifiMac> ();
  return mac;
}
