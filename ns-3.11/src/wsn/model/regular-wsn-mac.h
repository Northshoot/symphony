 ...
 */
#ifndef REGULAR_WSN_MAC_H
#define REGULAR_WSN_MAC_H
 ...
 *
 */
class RegularWsnMac : public WifiMac
{
public:
  static TypeId GetTypeId (void);

  RegularWsnMac ();
  virtual ~RegularWsnMac ();
...
private:
  RegularWsnMac (const RegularWsnMac &);
  RegularWsnMac & operator= (const RegularWsnMac &);
