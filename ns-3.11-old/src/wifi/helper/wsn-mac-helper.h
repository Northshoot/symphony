 ...
 */
#ifndef WSN_MAC_HELPER_H
#define WSN_MAC_HELPER_H
 ...
 */
class WsnWifiMacHelper : public WsnMacHelper
{
public:
  /**
   * Create a WsnMacHelper to make life easier for people who want to
  ...
  /**
   * \internal
   * Destroy a WsnMacHelper.
   */

  virtual ~WsnWifiMacHelper ();
  /**
   * Create a mac helper in a default working state.
   * i.e., this is an adhoc mac by default.
   */
  static WsnWifiMacHelper Default (void);
  /**
...
private:
   ...
   */
  virtual Ptr<WsnWifiMac> Create (void) const;
