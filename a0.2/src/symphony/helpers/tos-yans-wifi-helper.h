 ...
 */
#ifndef TOS_YANS_WIFI_HELPER_H
#define TOS_YANS_WIFI_HELPER_H
 ...
 *
 */
class TosYansWifiPhyHelper : public YansWifiPhyHelper//, public PcapHelperForDevice, public AsciiTraceHelperForDevice
{
public:
  /**
   ...
   */
//  static TosYansWifiPhyHelper Default (void);
//
//  /**
