...
TosWifiMacHelper::TosWifiMacHelper ()
{
}
...
TosWifiMacHelper
TosWifiMacHelper::Default (void)
{
	TosWifiMacHelper helper;
...
void
TosWifiMacHelper::SetType (std::string type,
...
Ptr<WifiMac>
TosWifiMacHelper::Create (void) const
{
