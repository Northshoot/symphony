...
if [ "$color_prompt" = yes ]; then
   # PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
    PS1="[\t][\e[0;32m\u\e[0;0m]@[\e[0;31m\H\e[0m]:[\e[0;33m\w\e[0;0m]\n->" 
...
SYMPHONY_WORK="/home/ubuntu/dev/symphony"
SYMPHONY_BASE=$SYMPHONY_WORK
SYMPHONY_BUILD="$SYMPHONY_BASE/$SYMPHONY_NS_VERSION/build"
SYMPHONY_SRC="$SYMPHONY_BASE/$SYMPHONY_NS_VERSION/src/symphony"
SYMPHONY_ELF=$SYMPHONY_BASE/elf

TOSROOT_BASE="/home/ubuntu/dev/tinyos_source"
...
LD_LIBRARY_PATH=/usr/lib:$SYMPHONY_BUILD/:$SYMPHONY_ELF/:$LD_LIBRARY_PATH
