...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2b35be1b41f0, const void *arg_0x2b35be1b44c8);
#line 776
__extension__ 
#line 793
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2b35be484868), 
int (*key_eq_fn)(void *arg_0x2b35be482020, void *arg_0x2b35be4822c0));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2b35be692288, int arg_0x2b35be6924f0);
static inline double RandomUniform(void );
...
# 52 "/home/onir/dev/skynet/tinyos-2.1.1/tos/interfaces/Random.nc"
...
# 52 "/home/onir/dev/skynet/tinyos-2.1.1/tos/interfaces/Random.nc"
static uint16_t BlinkC$Random$rand16(void );
# 11 "BlinkC.nc"
static inline void BlinkC$Boot$booted(void );
# 52 "/home/onir/dev/skynet/tinyos-2.1.1/tos/system/RandomMlcgC.nc"
...
# 78 "/home/onir/dev/skynet/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2b35bea5bb68, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2b35bea5bb68, msg, payload, len);
#line 78
...
# 78 "/home/onir/dev/skynet/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2b35bea5b020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2b35bea5b020, msg, payload, len);
#line 78
...
#line 78
# 232 "/home/onir/dev/skynet/tinyos-2.1.1/tos/lib/tossim/TossimActiveMessageC.nc"
static inline am_addr_t TossimActiveMessageC$default$amAddress(void )
#line 232
{
  return 0;
...
# 69 "/home/onir/dev/skynet/tinyos-2.1.1/tos/lib/tossim/SimSchedulerBasicP.nc"
static inline int SimSchedulerBasicP$sim_config_task_latency(void )
#line 69
{
#line 69
...
# 75 "/home/onir/dev/skynet/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2b35be794ab0){
#line 75
    SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2b35be794ab0);
#line 75
}
#line 75
# 51 "/home/onir/dev/skynet/tinyos-2.1.1/tos/platforms/mica/PlatformP.nc"
...
#line 65
# 55 "/home/onir/dev/skynet/tinyos-2.1.1/tos/system/RandomMlcgC.nc"
static inline error_t RandomMlcgC$Init$init(void )
#line 55
{
  /* atomic removed: atomic calls only */
...
# 89 "/home/onir/dev/skynet/tinyos-2.1.1/tos/system/RandomMlcgC.nc"
static inline uint16_t RandomMlcgC$Random$rand16(void )
#line 89
{
...
# 52 "/home/onir/dev/skynet/tinyos-2.1.1/tos/interfaces/Random.nc"
inline static uint16_t BlinkC$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
static inline void BlinkC$Boot$booted(void )
{
  ...
  for (i = 0; i < dimension; i++) {
      hv1[i] = BlinkC$Random$rand16();
      hv2[i] = BlinkC$Random$rand16();
    }


  for (i = 0; i < dimension; i++) {
      hvres[i] = hv1[i] ^ hv2[i];
      sim_log_debug(109U, "Boot", "hvres[%d] = %x <- hv1[%d] = %x - hv2[%d] = %x \n", i, hvres[i], i, hv1[i], i, hv2[i]);
    }
}
...
# 69 "/home/onir/dev/skynet/tinyos-2.1.1/tos/system/RandomMlcgC.nc"
static uint32_t RandomMlcgC$Random$rand32(void )
#line 69
{
  uint32_t mlcg;
