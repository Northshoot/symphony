 ...
 */
#ifndef TOS_WIFI_MAC_HELPER_H
#define TOS_WIFI_MAC_HELPER_H
 ...
 */
class TosWifiMacHelper : public WifiMacHelper
{
public:
  /**
   ...
   */
  static TosWifiMacHelper Default (void);
  /**
