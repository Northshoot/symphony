...
NS_LOG_COMPONENT_DEFINE ("TosYansWifiHelper");
...
TosYansWifiPhyHelper::TosYansWifiPhyHelper ()
  : m_channel (0),
...
TosYansWifiPhyHelper
TosYansWifiPhyHelper::Default (void)
{
  TosYansWifiPhyHelper helper;
...
Ptr<TosYansWifiPhy>
TosYansWifiPhyHelper::Create (Ptr<TosNode> node, Ptr<TosNetDevice> device) const
{
  Ptr<TosYansWifiPhy> phy = m_phy.Create<TosYansWifiPhy> ();
