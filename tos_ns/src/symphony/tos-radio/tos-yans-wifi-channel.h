 ...
 */
#ifndef TOS_YANS_WIFI_CHANNEL_H
#define TOS_YANS_WIFI_CHANNEL_H
 ...
 */
class TosYansWifiChannel : public WifiChannel
{
public:
  ...
  virtual Ptr<TosNetDevice> GetDevice (uint32_t i) const;

  void Add (Ptr<TosYansWifiPhy> phy);
   ...
   */
  void Send (Ptr<TosYansWifiPhy> sender, Ptr<const Packet> packet, double txPowerDbm,
             WifiMode wifiMode, WifiPreamble preamble) const;

private:
  typedef std::vector<Ptr<TosYansWifiPhy> > PhyList;
