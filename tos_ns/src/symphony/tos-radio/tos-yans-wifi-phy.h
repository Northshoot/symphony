...
#ifndef TOS_YANS_WIFI_PHY_H
#define TOS_YANS_WIFI_PHY_H
...
public:
  ...
  TosYansWifiPhy ();
  virtual ~TosYansWifiPhy ();

  void SetChannel (Ptr<TosYansWifiChannel> channel);
...
private:
  TosYansWifiPhy (const TosYansWifiPhy &o);
...
private:
  ...
  Ptr<TosYansWifiChannel> m_channel;
