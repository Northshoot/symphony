...
#define NS_LOG_APPEND_CONTEXT std::clog << "[tosnsradio=" << m_self << "] "
...
TosNsRadioTransmissionListener::TosNsRadioTransmissionListener ()
{
}
TosNsRadioTransmissionListener::~TosNsRadioTransmissionListener ()
{
...
void
TosNsRadioTransmissionListener::GotBlockAck (const CtrlBAckResponseHeader *blockAck,
                                         Mac48Address source)
{
}
void
TosNsRadioTransmissionListener::MissedBlockAck (void)
{
}
TosNsRadioDcfListener::TosNsRadioDcfListener ()
{
}
TosNsRadioDcfListener::~TosNsRadioDcfListener ()
{
...
TosNsRadioBlockAckEventListener::TosNsRadioBlockAckEventListener ()
{
}
TosNsRadioBlockAckEventListener::~TosNsRadioBlockAckEventListener ()
{
...
TosNsRadioTransmissionParameters::TosNsRadioTransmissionParameters ()
  : m_nextSize (0),
    m_waitAck (ACK_NONE),
    m_sendRts (false),
...
void
TosNsRadioTransmissionParameters::EnableNextData (uint32_t size)
{
  m_nextSize = size;
}
void
TosNsRadioTransmissionParameters::DisableNextData (void)
{
  m_nextSize = 0;
}
void
TosNsRadioTransmissionParameters::EnableOverrideDurationId (Time durationId)
{
  m_overrideDurationId = durationId;
}
void
TosNsRadioTransmissionParameters::DisableOverrideDurationId (void)
{
  m_overrideDurationId = Seconds (0);
}
void
TosNsRadioTransmissionParameters::EnableSuperFastAck (void)
{
  m_waitAck = ACK_SUPER_FAST;
}
void
TosNsRadioTransmissionParameters::EnableBasicBlockAck (void)
{
  m_waitAck = BLOCK_ACK_BASIC;
}
void
TosNsRadioTransmissionParameters::EnableCompressedBlockAck (void)
{
  m_waitAck = BLOCK_ACK_COMPRESSED;
}
void
TosNsRadioTransmissionParameters::EnableMultiTidBlockAck (void)
{
  m_waitAck = BLOCK_ACK_MULTI_TID;
}
void
TosNsRadioTransmissionParameters::EnableFastAck (void)
{
  m_waitAck = ACK_FAST;
}
void
TosNsRadioTransmissionParameters::EnableAck (void)
{
  m_waitAck = ACK_NORMAL;
}
void
TosNsRadioTransmissionParameters::DisableAck (void)
{
  m_waitAck = ACK_NONE;
}
void
TosNsRadioTransmissionParameters::EnableRts (void)
{
  m_sendRts = true;
}
void
TosNsRadioTransmissionParameters::DisableRts (void)
{
  m_sendRts = false;
}
bool
TosNsRadioTransmissionParameters::MustWaitAck (void) const
{
  return (m_waitAck != ACK_NONE);
}
bool
TosNsRadioTransmissionParameters::MustWaitNormalAck (void) const
{
  return (m_waitAck == ACK_NORMAL);
}
bool
TosNsRadioTransmissionParameters::MustWaitFastAck (void) const
{
  return (m_waitAck == ACK_FAST);
}
bool
TosNsRadioTransmissionParameters::MustWaitSuperFastAck (void) const
{
  return (m_waitAck == ACK_SUPER_FAST);
}
bool
TosNsRadioTransmissionParameters::MustWaitBasicBlockAck (void) const
{
  return (m_waitAck == BLOCK_ACK_BASIC) ? true : false;
}
bool
TosNsRadioTransmissionParameters::MustWaitCompressedBlockAck (void) const
{
  return (m_waitAck == BLOCK_ACK_COMPRESSED) ? true : false;
}
bool
TosNsRadioTransmissionParameters::MustWaitMultiTidBlockAck (void) const
{
  return (m_waitAck == BLOCK_ACK_MULTI_TID) ? true : false;
}
bool
TosNsRadioTransmissionParameters::MustSendRts (void) const
{
  return m_sendRts;
}
bool
TosNsRadioTransmissionParameters::HasDurationId (void) const
{
  return (m_overrideDurationId != Seconds (0));
}
Time
TosNsRadioTransmissionParameters::GetDurationId (void) const
{
  NS_ASSERT (m_overrideDurationId != Seconds (0));
  return m_overrideDurationId;
}
bool
TosNsRadioTransmissionParameters::HasNextPacket (void) const
{
  return (m_nextSize != 0);
}
uint32_t
TosNsRadioTransmissionParameters::GetNextPacketSize (void) const
{
  NS_ASSERT (HasNextPacket ());
  return m_nextSize;
}

std::ostream &operator << (std::ostream &os, const TosNsRadioTransmissionParameters &params)
{
  os << "["
  ...
  switch (params.m_waitAck) {
    case TosNsRadioTransmissionParameters::ACK_NONE:
      os << "none";
      break;
    case TosNsRadioTransmissionParameters::ACK_NORMAL:
      os << "normal";
      break;
    case TosNsRadioTransmissionParameters::ACK_FAST:
      os << "fast";
      break;
    case TosNsRadioTransmissionParameters::ACK_SUPER_FAST:
      os << "super-fast";
      break;
    case TosNsRadioTransmissionParameters::BLOCK_ACK_BASIC:
      os << "basic-block-ack";
      break;
    case TosNsRadioTransmissionParameters::BLOCK_ACK_COMPRESSED:
      os << "compressed-block-ack";
      break;
    case TosNsRadioTransmissionParameters::BLOCK_ACK_MULTI_TID:
...
/***************************************************************
 *         Listener for PHY events. Forwards to TosNsRadio
 ***************************************************************/


class PhyTosNsRadioListener : public ns3::WifiPhyListener {
public:
  PhyTosNsRadioListener (ns3::TosNsRadio *macLow)
    : m_macLow (macLow) {}
  virtual ~PhyTosNsRadioListener () {}
...
private:
  ns3::TosNsRadio *m_macLow;
};


TosNsRadio::TosNsRadio ()
...
void
TosNsRadio::SetupPhyTosNsRadioListener (Ptr<WifiPhy> phy)
{
  m_phyTosNsRadioListener = new PhyTosNsRadioListener (this);
  phy->RegisterListener (m_phyTosNsRadioListener);
}


void
TosNsRadio::DoDispose (void)
{
  NS_LOG_FUNCTION (this);
  ...
  m_phy = 0;
  m_stationManager = 0;
  delete m_phyTosNsRadioListener;
  m_phyTosNsRadioListener = 0;
}

void
TosNsRadio::CancelAllEvents (void)
{
  NS_LOG_FUNCTION (this);
...
void
TosNsRadio::SetPhy (Ptr<WifiPhy> phy)
{
  m_phy = phy;
  m_phy->SetReceiveOkCallback (MakeCallback (&TosNsRadio::ReceiveOk, this));
  m_phy->SetReceiveErrorCallback (MakeCallback (&TosNsRadio::ReceiveError, this));
  SetupPhyTosNsRadioListener(phy);
}
void
TosNsRadio::SetWifiRemoteStationManager (Ptr<WifiRemoteStationManager> manager)
{
  m_stationManager = manager;
}

void
TosNsRadio::SetAddress (Mac48Address ad)
{
  m_self = ad;
}
void
TosNsRadio::SetAckTimeout (Time ackTimeout)
{
  m_ackTimeout = ackTimeout;
}
void
TosNsRadio::SetBasicBlockAckTimeout (Time blockAckTimeout)
{
  m_basicBlockAckTimeout = blockAckTimeout;
}
void
TosNsRadio::SetCompressedBlockAckTimeout (Time blockAckTimeout)
{
  m_compressedBlockAckTimeout = blockAckTimeout;
}
void
TosNsRadio::SetCtsTimeout (Time ctsTimeout)
{
  m_ctsTimeout = ctsTimeout;
}
void
TosNsRadio::SetSifs (Time sifs)
{
  m_sifs = sifs;
}
void
TosNsRadio::SetSlotTime (Time slotTime)
{
  m_slotTime = slotTime;
}
void
TosNsRadio::SetPifs (Time pifs)
{
  m_pifs = pifs;
}
void
TosNsRadio::SetBssid (Mac48Address bssid)
{
  m_bssid = bssid;
}
Mac48Address
TosNsRadio::GetAddress (void) const
{
  return m_self;
}
Time
TosNsRadio::GetAckTimeout (void) const
{
  return m_ackTimeout;
}
Time
TosNsRadio::GetBasicBlockAckTimeout () const
{
  return m_basicBlockAckTimeout;
}
Time
TosNsRadio::GetCompressedBlockAckTimeout () const
{
  return m_compressedBlockAckTimeout;
}
Time
TosNsRadio::GetCtsTimeout (void) const
{
  return m_ctsTimeout;
}
Time
TosNsRadio::GetSifs (void) const
{
  return m_sifs;
}
Time
TosNsRadio::GetSlotTime (void) const
{
  return m_slotTime;
}
Time
TosNsRadio::GetPifs (void) const
{
  return m_pifs;
}
Mac48Address
TosNsRadio::GetBssid (void) const
{
  return m_bssid;
}

void
TosNsRadio::SetRxCallback (Callback<void,Ptr<Packet>,const WifiMacHeader *> callback)
{
  m_rxCallback = callback;
}
void
TosNsRadio::RegisterDcfListener (TosNsRadioDcfListener *listener)
{
...
void
TosNsRadio::StartTransmission (Ptr<const Packet> packet,
                           const WifiMacHeader* hdr,
                           TosNsRadioTransmissionParameters params,
                           TosNsRadioTransmissionListener *listener)
{
...
void
TosNsRadio::ReceiveError (Ptr<const Packet> packet, double rxSnr)
{
  ...
  if (m_txParams.MustWaitFastAck ()) 
    {
      ...
      m_fastAckFailedTimeoutEvent = Simulator::Schedule (GetSifs (), 
                                                         &TosNsRadio::FastAckFailedTimeout, this);
    }
  return;
}

void 
TosNsRadio::NotifySwitchingStartNow (Time duration)
{
...
void 
TosNsRadio::ReceiveOk (Ptr<Packet> packet, double rxSnr, WifiMode txMode, WifiPreamble preamble)
{
  ...
  if (hdr.IsRts ()) 
      ...
      if (isPrevNavZero &&
          hdr.GetAddr1 () == m_self) 
        {
          ...
          m_sendCtsEvent = Simulator::Schedule (GetSifs (),
                                                &TosNsRadio::SendCtsAfterRts, this,
                                                hdr.GetAddr2 (), 
                                                hdr.GetDuration (),
                                                txMode,
                                                rxSnr);
           ...
           m_currentPacket != 0) 
    {
      ...
      m_sendDataEvent = Simulator::Schedule (GetSifs (), 
                                             &TosNsRadio::SendDataAfterCts, this,
                                             hdr.GetAddr1 (),
                                             hdr.GetDuration (),
                                             txMode);
    } 
      ...
      if (m_txParams.HasNextPacket ()) 
        {
          m_waitSifsEvent = Simulator::Schedule (GetSifs (), 
                                                 &TosNsRadio::WaitSifsAfterEndTx, this);
        }
    } 
              ...
              if ((*it).second.first.IsImmediateBlockAck ())
                {
                  ...
                  m_sendAckEvent = Simulator::Schedule (GetSifs (),
                                                        &TosNsRadio::SendBlockAckAfterBlockAckRequest, this,
                                                        blockAckReq,
                                                        hdr.GetAddr2 (), 
                                                        hdr.GetDuration (),
                                                        txMode);
          ...
          if (hdr.IsQosAck ())
            {
              ...
              NS_ASSERT (m_sendAckEvent.IsExpired ());
              m_sendAckEvent = Simulator::Schedule (GetSifs (),
                                                    &TosNsRadio::SendAckAfterData, this,
                                                    hdr.GetAddr2 (), 
                                                    hdr.GetDuration (),
                                                    txMode,
                                                    rxSnr);
...
uint32_t 
TosNsRadio::GetAckSize (void) const
{
  WifiMacHeader ack;
...
uint32_t
TosNsRadio::GetBlockAckSize (enum BlockAckType type) const
{
  WifiMacHeader hdr;
...
uint32_t 
TosNsRadio::GetRtsSize (void) const
{
  WifiMacHeader rts;
...
Time
TosNsRadio::GetAckDuration (Mac48Address to, WifiMode dataTxMode) const
{
  WifiMode ackMode = GetAckTxModeForData (to, dataTxMode);
  return m_phy->CalculateTxDuration (GetAckSize (), ackMode, WIFI_PREAMBLE_LONG);
}
Time
TosNsRadio::GetBlockAckDuration (Mac48Address to, WifiMode blockAckReqTxMode, enum BlockAckType type) const
{
  /* 
...
WifiMode
TosNsRadio::GetRtsTxMode (Ptr<const Packet> packet, const WifiMacHeader *hdr) const
{
...
WifiMode
TosNsRadio::GetCtsTxModeForRts (Mac48Address to, WifiMode rtsTxMode) const
{
  return m_stationManager->GetCtsMode (to, rtsTxMode);
}
WifiMode
TosNsRadio::GetAckTxModeForData (Mac48Address to, WifiMode dataTxMode) const
{
...
Time
TosNsRadio::CalculateOverallTxTime (Ptr<const Packet> packet,
                                const WifiMacHeader* hdr, 
                                const TosNsRadioTransmissionParameters& params) const
{
...
Time
TosNsRadio::CalculateTransmissionTime (Ptr<const Packet> packet,
                                   const WifiMacHeader* hdr, 
                                   const TosNsRadioTransmissionParameters& params) const
{
...
void
TosNsRadio::NotifyNav (const WifiMacHeader &hdr, WifiMode txMode, WifiPreamble preamble)
{
      ...
      if (hdr.IsRts () && navUpdated)
        {
          ...
          m_navCounterResetCtsMissed = Simulator::Schedule (navCounterResetCtsMissedDelay,
                                                            &TosNsRadio::NavCounterResetCtsMissed, this,
                                                            Simulator::Now ());
        }
    }
}
...
void
TosNsRadio::NavCounterResetCtsMissed (Time rtsEndRxTime)
{
...
void
TosNsRadio::DoNavResetNow (Time duration)
{
...
bool
TosNsRadio::DoNavStartNow (Time duration)
{
  for (DcfListenersCI i = m_dcfListeners.begin (); i != m_dcfListeners.end (); i++) 
    {
      (*i)->NavStart (duration);
...
void
TosNsRadio::NotifyAckTimeoutStartNow (Time duration)
{
  for (DcfListenersCI i = m_dcfListeners.begin (); i != m_dcfListeners.end (); i++) 
    {
...
void
TosNsRadio::NotifyAckTimeoutResetNow ()
{
  for (DcfListenersCI i = m_dcfListeners.begin (); i != m_dcfListeners.end (); i++) 
    {
      (*i)->AckTimeoutReset ();
...
void
TosNsRadio::NotifyCtsTimeoutStartNow (Time duration)
{
  for (DcfListenersCI i = m_dcfListeners.begin (); i != m_dcfListeners.end (); i++) 
    {
...
void
TosNsRadio::NotifyCtsTimeoutResetNow ()
{
  for (DcfListenersCI i = m_dcfListeners.begin (); i != m_dcfListeners.end (); i++) 
    {
      (*i)->CtsTimeoutReset ();
...
void
TosNsRadio::ForwardDown (Ptr<const Packet> packet, const WifiMacHeader* hdr,
                     WifiMode txMode)
{
...
TosNsRadio::CtsTimeout (void)
{
  ...
  m_currentPacket = 0;
  TosNsRadioTransmissionListener *listener = m_listener;
  m_listener = 0;
  listener->MissedCts ();
}
void
TosNsRadio::NormalAckTimeout (void)
{
  NS_LOG_FUNCTION (this);
...
void
TosNsRadio::FastAckTimeout (void)
{
  NS_LOG_FUNCTION (this);
  m_stationManager->ReportDataFailed (m_currentHdr.GetAddr1 (), &m_currentHdr);
  TosNsRadioTransmissionListener *listener = m_listener;
...
void
TosNsRadio::BlockAckTimeout (void)
{
  NS_LOG_FUNCTION (this);
...
void
TosNsRadio::SuperFastAckTimeout ()
{
  NS_LOG_FUNCTION (this);
  m_stationManager->ReportDataFailed (m_currentHdr.GetAddr1 (), &m_currentHdr);
  TosNsRadioTransmissionListener *listener = m_listener;
...
void
TosNsRadio::SendRtsForPacket (void)
{
  NS_LOG_FUNCTION (this);
  ...
  m_ctsTimeoutEvent = Simulator::Schedule (timerDelay, &TosNsRadio::CtsTimeout, this);
...
void
TosNsRadio::StartDataTxTimers (void)
{
  WifiMode dataTxMode = GetDataTxMode (m_currentPacket, &m_currentHdr);
  ...
  if (m_txParams.MustWaitNormalAck ()) 
    {
      ...
      m_normalAckTimeoutEvent = Simulator::Schedule (timerDelay, &TosNsRadio::NormalAckTimeout, this);
    } 
  else if (m_txParams.MustWaitFastAck ()) 
    {
      ...
      NotifyAckTimeoutStartNow (timerDelay);
      m_fastAckTimeoutEvent = Simulator::Schedule (timerDelay, &TosNsRadio::FastAckTimeout, this);
    } 
  else if (m_txParams.MustWaitSuperFastAck ()) 
    {
      ...
      m_superFastAckTimeoutEvent = Simulator::Schedule (timerDelay, 
                                                        &TosNsRadio::SuperFastAckTimeout, this);
    }
  else if (m_txParams.MustWaitBasicBlockAck ())
    {
      ...
      m_blockAckTimeoutEvent = Simulator::Schedule (timerDelay, &TosNsRadio::BlockAckTimeout, this);
    }
  ...
  else if (m_txParams.HasNextPacket ()) 
    {
      ...
      m_waitSifsEvent = Simulator::Schedule (delay, &TosNsRadio::WaitSifsAfterEndTx, this);
    } 
  else 
    {
...
void
TosNsRadio::SendDataPacket (void)
{
  NS_LOG_FUNCTION (this);
...
bool 
TosNsRadio::IsNavZero (void) const
{
...
void
TosNsRadio::SendCtsAfterRts (Mac48Address source, Time duration, WifiMode rtsTxMode, double rtsSnr)
{
...
void
TosNsRadio::SendDataAfterCts (Mac48Address source, Time duration, WifiMode txMode)
{
  NS_LOG_FUNCTION (this);
...
void 
TosNsRadio::WaitSifsAfterEndTx (void)
{
  m_listener->StartNext ();
}

void
TosNsRadio::FastAckFailedTimeout (void)
{
  NS_LOG_FUNCTION (this);
  TosNsRadioTransmissionListener *listener = m_listener;
  m_listener = 0;
...
void
TosNsRadio::SendAckAfterData (Mac48Address source, Time duration, WifiMode dataTxMode, double dataSnr)
{
  NS_LOG_FUNCTION (this);
...
bool
TosNsRadio::StoreMpduIfNeeded (Ptr<Packet> packet, WifiMacHeader hdr)
{
  AgreementsI it = m_bAckAgreements.find (std::make_pair (hdr.GetAddr2 (), hdr.GetQosTid ()));
  if (it != m_bAckAgreements.end ())
    {
...
void
TosNsRadio::DestroyBlockAckAgreement (Mac48Address originator, uint8_t tid)
{
...
void
TosNsRadio::RxCompleteBufferedPacketsWithSmallerSequence (uint16_t seq, Mac48Address originator, uint8_t tid)
{
  AgreementsI it = m_bAckAgreements.find (std::make_pair (originator, tid));
  if (it != m_bAckAgreements.end ())
    {
...
void
TosNsRadio::RxCompleteBufferedPacketsUntilFirstLost (Mac48Address originator, uint8_t tid)
{
  AgreementsI it = m_bAckAgreements.find (std::make_pair (originator, tid));
  if (it != m_bAckAgreements.end ())
    {
...
void
TosNsRadio::SendBlockAckResponse (const CtrlBAckResponseHeader* blockAck, Mac48Address originator, bool immediate,
...
void
TosNsRadio::SendBlockAckAfterBlockAckRequest (const CtrlBAckRequestHeader reqHdr, Mac48Address originator,
                                          Time duration, WifiMode blockAckReqTxMode)
{
  NS_LOG_FUNCTION (this);
  CtrlBAckResponseHeader blockAck;
...
void
TosNsRadio::RegisterBlockAckListenerForAc (enum AcIndex ac, TosNsRadioBlockAckEventListener *listener)
{
